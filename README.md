...
We used Python to develop the [code](https://github.com/Marietas/surfs_up/blob/main/SurfsUp_Challenge.ipynb) to analyze and evaluate the temperature trends in Oahu for June and December for the period mentioned on the overview. The data includes 1700 records for June 1517 for December. 
